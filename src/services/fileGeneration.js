...
class FileGenerationService {
    ...
    static async generatePdf(templatePath, templateData, outputPdfPath, pdfOptions) {
        try {
    ...
    static async generateWeeklyXlsx(excelGenerationData, outputExcelPath, excelConfig = {}) {
        try {
            // Create a new Excel workbook and worksheet
            const workbook = new excel.Workbook();
            const worksheet = workbook.addWorksheet(excelConfig?.sheetName);
